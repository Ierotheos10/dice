...
> Άνοιγμα αυτής της σελίδας στο [https://ierotheos10.github.io/dice/](https://ierotheos10.github.io/dice/)
...
* αναζήτηση για **https://github.com/ierotheos10/dice** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/ierotheos10/dice/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/ierotheos10/dice** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/ierotheos10/dice/raw/master/.github/makecode/blocks.png)
